...
import ru.vsu.cs.maslova_e_i.ObjToken;
import ru.vsu.cs.maslova_e_i.Vector2f;
import ru.vsu.cs.maslova_e_i.Vector3f;
import ru.vsu.cs.maslova_e_i.Model;
import ru.vsu.cs.maslova_e_i.Polygon;
...
public class ObjReader {
    ...
    protected static String parseMaterialLib(List<String> wordsInLine, int fileLineId) {
    ...
    protected static String parseMaterial(Model model, List<String> wordsInLine, int fileLineId) {
